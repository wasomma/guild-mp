...
Status: **style locked 2026-07-21** from the owner's reference picks. **Character direction locked 2026-07-22:** the fidelity-study question is resolved by the **HD canvas** decision — source-native generated heroes (~246px art) on a 2× render canvas, adopted in phases (ART-PIPELINE.md Phase 7). Phase C shipped the kitsune; Phase D's first wave (v0.1.23) ships the tank class bodies as hybrid layered puppets — generated base body + outfit/hair/weapon overlay layers, hair runtime-tinted, weapons runtime ramp-swapped. Heroes whose equipped combination has no full HD layer set (hats, capes, accessories, non-warrior styles, other classes) remain procedural paperdolls until their wave lands.
