...
- `qa-kitsune-preview.mjs` + `prototype/kitsune-preview.html` : biome/cosmetic preview harness (arg: a stage number or "feast"); `qa-kitsune-set.mjs` : headless kitsune render regression.
