...
- `qa-kitsune-preview.mjs` + `prototype/kitsune-preview.html` : biome/cosmetic preview harness (arg: a stage number or "feast"); `qa-pet-preview.mjs` + `prototype/pet-preview.html` : animated feast pet-corner review harness (six members, one of each pet); `qa-kitsune-set.mjs` : headless kitsune render regression.
