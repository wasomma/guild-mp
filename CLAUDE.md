...
- `client/public/assets/zones/` : generated background plates (docs/ART-PIPELINE.md). App.jsx loads them into the renderer's BG_PLATES registry; a missing file leaves that scene's procedural background in place.
