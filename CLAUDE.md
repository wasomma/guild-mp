...
- `client/public/assets/zones/`, `client/public/assets/props/`, `client/public/assets/ground/` : generated background plates, midground prop sets, and seamless ground strips (docs/ART-PIPELINE.md). App.jsx loads them into the renderer's BG_PLATES / PROP_SPRITES / GROUND_STRIPS registries; missing files leave that scene's procedural art in place. Prop sets are slot arrays (0 = anchor, 1+ = small props) placed by a deterministic world-tile hash, drawn base-sunk with contact shadows; ground strips tile horizontally at full parallax.
